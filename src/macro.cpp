...
void Macro::addDefinition(Fetcher& fetcher)
{
   ...
   if (fetcher.isBlankLine())
      fetcher.die("equivalence required for identifier \"%s\"",d.identifier.c_str());
...
void Macro::process(Fetcher& fetcher, const char *macros[])
{
